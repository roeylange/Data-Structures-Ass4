...
public class BTree<T extends Comparable<T>> {
    ...
    protected Deque<Object> MotherList=new LinkedList<Object>(); 	//this is our list of backtracks;
    ...
    public void insert(T value) {
    	...
    	MotherList.addLast(null);				//we insert null as our first information that will come between two backtracks
    	...
    	if (root == null) {
            ...
            while (currentNode != null && !wasAdded) {
                ...
                if (currentNode.getNumberOfKeys() == maxDegree - 1) {
                	...
                	T medVal=split(currentNode);	//we save the value that goes to the upper node
                	MotherList.addLast(medVal);		//we insert the value to the list
